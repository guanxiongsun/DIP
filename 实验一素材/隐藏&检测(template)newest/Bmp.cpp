...
//	} lsh in 2002-5-27 because the bitmap manipulated by 
//software Batch it leads to bitmap filehead changed.
...
{
	pSrc->SaveBitmap("c:\\tmp.bmp");
	return LoadBitmap("c:\\tmp.bmp");
}
